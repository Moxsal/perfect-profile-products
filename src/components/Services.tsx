...
import construction4 from "@/assets/construction-4.jpeg";
import construction5 from "@/assets/construction-5.jpeg";
  ...
  const services = [
    {
      ...
      images: [construction1, construction4, construction5],
      features: [
    ...
    },
    {
      ...
      images: [construction2, construction5, construction4],
      features: [
    ...
    },
    {
      ...
      images: [construction3, construction4],
      features: [
    ...
    },
    {
      ...
      images: [popCeiling1, popCeiling2, lighting3],
      features: [
    ...
    },
    {
      ...
      images: [popCeiling2, construction4, popCeiling1],
      features: [
    ...
    },
    {
      ...
      images: [lighting2, construction3],
      features: [
    ...
    },
    {
      ...
      images: [construction1, construction4, popCeiling1],
      features: [
    ...
    },
    {
      ...
      images: [construction3, construction5, construction4],
      features: [
